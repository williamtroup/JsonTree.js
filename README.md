...
[![npm](https://img.shields.io/badge/npmjs-v3.2.0-blue)](https://www.npmjs.com/package/jjsontree.js)
[![nuget](https://img.shields.io/badge/nuget-v3.2.0-purple)](https://www.nuget.org/packages/jJsonTree.js/)
...
- 🔍 21 types supported by default (such as Object, Array, primitive types, and even Sets and Maps).
...
```markdown
https://cdn.jsdelivr.net/gh/williamtroup/JsonTree.js@3.2.0/dist/jsontree.min.js
https://cdn.jsdelivr.net/gh/williamtroup/JsonTree.js@3.2.0/dist/jsontree.js.min.css
```
<br>
<br>
