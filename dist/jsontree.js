    ...
    function T(t, n, o, l) {
        if (t.controlPanel.enabled) {
            ...
            if (a && t.controlPanel.showExportButton) {
                const n = DomElement.createWithHTML(i, "button", "export", e.text.exportButtonSymbolText);
                n.onclick = () => he(t, o);
