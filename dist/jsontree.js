...
(() => {
    ...
    function x(e, t, n, o, r, l, i, s, a) {
        const u = r.length;
        if (!o.reverseArrayValues) {
            for (let e = 0; e < u; e++) {
                const t = C(e, o);
                const l = a === "" ? t.toString() : `${a}${"\\"}${t}`;
                h(r, n, o, _(o, t, u), r[e], e === u - 1, true, l);
            }
        } else {
            for (let e = u; e--; ) {
                const t = C(e, o);
                const l = a === "" ? t.toString() : `${a}${"\\"}${t}`;
                h(r, n, o, _(o, t, u), r[e], e === 0, true, l);
            }
        }
        if (o.showOpeningClosingCurlyBraces) {
            j(o, n, "]", i, s);
        ...
        if (l === null) {
            ...
            if (!o.ignore.stringValues) {
                if (o.parse.stringsToBooleans && Is.String.boolean(l)) {
                    h(t, n, o, r, l.toString().toLowerCase().trim() === "true", i, s, a);
                    g = true;
                } else if (o.parse.stringsToNumbers && !isNaN(l)) {
                    h(t, n, o, r, parseFloat(l), i, s, a);
                    g = true;
                } else if (o.parse.stringsToDates && Is.String.date(l)) {
                    h(t, n, o, r, new Date(l), i, s, a);
                    g = true;
                } else {
