...
(() => {
    ...
    function w(t, n) {
        ...
        const i = DomElement.create(r, "div", "control-buttons");
        const s = DomElement.create(i, "div", "control-button fill");
        const a = DomElement.create(i, "div", "control-button");
    ...
    function v(t, n, o) {
        ...
        if (a !== 0 || !n.ignore.emptyObjects) {
            ...
            if (n.showCounts && a > 0) {
                DomElement.createWithHTML(u, "span", n.showValueColors ? `${r} count` : "count", `{${a}}`);
            }
    ...
    function h(t, n, o) {
        ...
        const c = DomElement.createWithHTML(s, "span", n.showValueColors ? `${r} main-title` : "main-title", l ? e.text.setText : e.text.arrayText);
        let d = null;
        if (n.showCounts) {
            DomElement.createWithHTML(s, "span", n.showValueColors ? `${r} count` : "count", `[${i.length}]`);
        }
        if (n.showOpeningClosingCurlyBraces) {
            d = DomElement.createWithHTML(s, "span", "opening-symbol", "[");
        }
        E(u, null, a, n, i, d, false, true, "");
        C(n, c, o, r, false);
    }
    function V(e, t, n, o, l, r, i, s, a, u) {
        const c = r.length;
        for (let e = 0; e < c; e++) {
            const t = r[e];
            const i = u === "" ? t : `${u}${"\\"}${t}`;
            if (l.hasOwnProperty(t)) {
                S(l, n, o, t, l[t], e === c - 1, false, i);
            }
        }
    ...
    function E(e, t, n, o, l, r, i, s, a) {
        const u = l.length;
        if (!o.reverseArrayValues) {
            for (let e = 0; e < u; e++) {
                const t = M(e, o);
                const r = a === "" ? t.toString() : `${a}${"\\"}${t}`;
                S(l, n, o, j(o, t, u), l[e], e === u - 1, true, r);
            }
        } else {
            for (let e = u; e--; ) {
                const t = M(e, o);
                const r = a === "" ? t.toString() : `${a}${"\\"}${t}`;
                S(l, n, o, j(o, t, u), l[e], e === 0, true, r);
            }
        }
        if (o.showOpeningClosingCurlyBraces) {
            k(o, n, "]", i, s);
        ...
        if (r === null) {
            ...
            if (!o.ignore.stringValues) {
                if (o.parse.stringsToBooleans && Is.String.boolean(r)) {
                    S(t, n, o, l, r.toString().toLowerCase().trim() === "true", i, s, a);
                    g = true;
                } else if (o.parse.stringsToNumbers && !isNaN(r)) {
                    S(t, n, o, l, parseFloat(r), i, s, a);
                    g = true;
                } else if (o.parse.stringsToDates && Is.String.date(r)) {
                    S(t, n, o, l, new Date(r), i, s, a);
                    g = true;
                } else {
