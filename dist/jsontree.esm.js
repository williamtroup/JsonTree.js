...
(() => {
    ...
    function s(t, n) {
        if (!Is.definedString(t.title.text) || t.title.showTreeControls || t.title.showCopyButton || t.sideMenu.enabled || t.showArrayItemsAsSeparateObjects) {
    ...
    function p(t) {
        if (t.sideMenu.enabled) {
            ...
            t._currentView.disabledBackground.onclick = () => y(t);
