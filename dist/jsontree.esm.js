        ...
        (() => {
            ...
            function renderObject(e, t, n, r = false) {
                ...
                if (i !== 0 || !t.ignore.emptyObjects) {
                    ...
                    renderObjectValues(s, null, a, t, n, o, c, false, true);
                ...
                if (o === null) {
                    ...
                    if (!n.ignore.stringValues) {
                        if (n.parse.stringsToBooleans && Is.String.boolean(o)) {
                            ...
                            let t = null;
                            if (n.showValueColors && n.showStringHexColors && Is.String.hexColor(o)) {
                                t = o;
                            } else {
                            ...
                            const s = n.showStringQuotes ? `"${o}"` : o;
