...
(() => {
    ...
    function s(t, n, o, l, r, i, a) {
        ...
        if (!Is.defined(t)) {
            ...
            if (Is.definedArray(t)) {
                ...
                $(s, o, Convert2.htmlToObject(t), l, "html");
            } else if (Is.definedMap(t)) {
    ...
    function $(t, n, o, l, r) {
        ...
        if (a !== 0 || !n.ignore.emptyObjects) {
            ...
            J(d, null, c, n, o, i, g, m, false, true, "", r);
            q(n, f, o, r, false);
            H(n, o, f);
            R(n, o, f);
        }
    ...
    function z(t, n, o, l) {
        ...
        U(s, null, a, n, o, c, d, false, true, "", l);
        q(n, u, o, l, false);
        H(n, o, u);
        R(n, o, u);
    }
    function J(t, n, o, l, r, i, a, s, u, c, d, f) {
        let g = true;
        const m = i.length;
        const p = d !== "" ? m : 0;
        ...
        if (r === null) {
            ...
            if (!o.ignore.objectValues) {
                ...
                if (n === 0 && o.ignore.emptyObjects) {
                    ...
                    let m = te(o, l, i);
                    const p = J(d, m, a, o, r, t, u, f, true, i, s, T);
                    if (!p && Is.defined(u)) {
                        u.parentNode.removeChild(u);
                    }
                }
